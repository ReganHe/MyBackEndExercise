...
namespace OAuth2Client.Common.Utils
{
    ...
    public static class Strings
    {
        ...
        {
            return Left(inputString, len, "");
        }
        public static string Left(string inputString, int len, string _endstr)
        {
            if (inputString.Length < len)
                return inputString;
            else
                return inputString.Substring(0, len) + _endstr;
        }
        /// <summary>
        /// 右截取
        /// </summary>
        ...
        public static string RemoveAllSpace(string _str)
        {
            string _content = _str.Replace("\r", "")
                .Replace("\n", "")
                .Replace("\t", "")
                .Replace("\v", "")
                .Replace(" ", "")
                ...
                .Replace("　", "")
                .Replace("�", "");//ASCII 56256
            return DeleteUnVisibleChar(_content);
        }
        ...
        /// <returns></returns>
        public static string GetASCIIStr(string _str)
        {
            byte[] array = System.Text.Encoding.ASCII.GetBytes(_str);
            string str = null;
        ...
        /// <param name="_str"></param>
        /// <returns></returns>
        public static int GetAsciiInt(string _str)
        {
            byte[] array = System.Text.Encoding.ASCII.GetBytes(_str);
            return array[0];
        }
        ...
        /// <param name="theString"></param>
        /// <returns></returns>
        public static string FilterFFSymbol(string theString)
        {
            string[] aryReg = { "\\", "\"", "\r", "\n", "<", ">", "%", "?", "*", ":", "|", "/", "\t" };
            for (int i = 0; i < aryReg.Length; i++)
            {
            ...
            return RemoveAllSpace(theString);
        }
        /// <summary>
        ...
        /// <param name="theString"></param>
        /// <returns></returns>
        public static string SafetyField(string theString)
        {
            string[] aryReg = { "'", "\"", "\r", "\n", "<", ">", "%", "?", "=", "-", "|", "[", "]", "&", "/" };
            for (int i = 0; i < aryReg.Length; i++)
            {
