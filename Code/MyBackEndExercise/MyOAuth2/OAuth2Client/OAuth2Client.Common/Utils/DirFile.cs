...
namespace OAuth2Client.Common.Utils
{
    ...
    public static class DirFile
    {
        ...
        /// <returns></returns>
        public static bool DownloadFile(System.Web.HttpRequest _Request, System.Web.HttpResponse _Response, string _fullPath, string _fileName, long _speed)
        {
            if(_fileName=="")
                _fileName = GetFileName(false, _fullPath);
            try
            {
